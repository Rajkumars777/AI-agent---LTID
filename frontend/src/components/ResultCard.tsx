        ...
        >
            ...
            <div className="px-5 py-4 flex items-center justify-between bg-white/[0.02] border-b border-white/5">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <h3 className="text-sm font-bold text-foreground tracking-tight">{displayTitle}</h3>
                        <p className="text-[10px] text-muted-foreground uppercase tracking-widest font-medium">Nexus Intelligence Output</p>
                    </div>
                </div>
                ...
                <div className={cn(
                    ...
                    {status === "pending" && <div className="w-2 h-2 rounded-full bg-amber-400 animate-pulse" />}
                ...
                {isFileList ? (
                    <div className="divide-y divide-white/5 max-h-[400px] overflow-y-auto custom-scrollbar">
                        {(processedContent as string[]).map((file: string, idx: number) => (
                            <div key={idx} className="flex items-center justify-between p-3.5 hover:bg-white/[0.03] transition-all group px-5">
                                <div className="flex items-center gap-3">
                                    <div className="p-2 bg-secondary rounded-lg text-muted-foreground group-hover:text-primary transition-colors">
                                        <FileText className="w-4 h-4" />
                                    </div>
                                    <span className="text-sm text-foreground font-medium truncate max-w-[500px]">{file}</span>
                                </div>
