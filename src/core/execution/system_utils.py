...
def open_app(app_name):
    ...
    # For now, simplistic approach as per plan, but we should probably use the robust launch_application from src.services.
    # However, the user plan implied a simple open_app. 
    # Let's import the robust one to be safe.
    from src.services.desktop.ops import open_application
